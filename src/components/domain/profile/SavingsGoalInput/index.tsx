...
export function SavingsGoalInput({
  ...
  return (
    <View>
      ...
      <TouchableOpacity
        style={[styles.dateRow, !!error && !amount && styles.dateRowError]}
      ...
      {/* 목표 금액 */}
      <View style={[styles.amountWrapper, !!error && !!dateLabel && styles.amountWrapperError]}>
        <TextInput
                ...
                {SAVINGS_MONTHS.map((month) => {
                  ...
                  return (
                    <TouchableOpacity
                      key={month}
                      style={[styles.pickerItem, isSelected && styles.pickerItemSelected]}
                      onPress={() => setTempMonth(month.toString())}
                      activeOpacity={0.7}
                    >
                      <Text
                        style={[styles.pickerItemText, isSelected && styles.pickerItemTextSelected]}
